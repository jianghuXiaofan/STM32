...
#define IIC_CLK_Clk     RCC_APB2Periph_GPIOB
#define IIC_CLK_Pin     GPIO_Pin_13
#define IIC_CLK_Port    GPIOB

#define IIC_DAT_Clk     RCC_APB2Periph_GPIOB
#define IIC_DAT_Pin     GPIO_Pin_15
#define IIC_DAT_Port    GPIOB
