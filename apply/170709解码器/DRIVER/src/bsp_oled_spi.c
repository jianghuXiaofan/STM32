...
{ 	
    GPIO_InitTypeDef  GPIO_InitStructure;
 	...
 	RCC_APB2PeriphClockCmd(OLED_SCLK_CLK|OLED_SDIN_CLK|OLED_RST_CLK|OLED_DC_CLK, ENABLE);	 //使能A端口时钟
	GPIO_InitStructure.GPIO_Pin = OLED_SCLK_PIN;	 
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //推挽输出
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	GPIO_Init(OLED_SCLK_PORT, &GPIO_InitStructure);	  //初始化GPIOD3,6
...
{   
    ...
    Usart1_Init(115200);
    OLED_Init();
    //OLED_ShowNum(0,0,328,3,16);
    //OLED_ShowNum(0,1,323,3,8);
    //OLED_ShowChar(32,0,'w',16);
    //OLED_ShowString(50,0,"12345678900987654321",16);
    //OLED_ShowCHinese(100,0,0);
