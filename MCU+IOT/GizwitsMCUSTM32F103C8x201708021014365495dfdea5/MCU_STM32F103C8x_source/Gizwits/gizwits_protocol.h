...
* @{
*/
#define PRODUCT_KEY "5dfdea58a6b548ce901d87ef4647489e"
/**@} */
/**@name Product Secret (产品密钥)
* @{
*/
#define PRODUCT_SECRET "a0fdd8ca771240079779f27bbb88a741"
/**@} */
...
* @{
*/
#define RGBLED_ONOFF_BYTEOFFSET                    0
#define RGBLED_ONOFF_BITOFFSET                     0
#define RGBLED_ONOFF_LEN                           1


#define RED_LED_RATIO                         1
#define RED_LED_ADDITION                      0
#define RED_LED_MIN                           0
#define RED_LED_MAX                           254

#define GREEN_LED_RATIO                         1
#define GREEN_LED_ADDITION                      0
#define GREEN_LED_MIN                           0
#define GREEN_LED_MAX                           254

#define BLUE_LED_RATIO                         1
#define BLUE_LED_ADDITION                      0
#define BLUE_LED_MIN                           0
#define BLUE_LED_MAX                           254
...
/** 用户区设备状态结构体*/
typedef_t struct {
  bool valueRgbLed_OnOff;
  uint32_t valueRed_Led;
  uint32_t valueGreen_Led;
  uint32_t valueBlue_Led;
} dataPoint_t;

/** 对应协议“4.10 WiFi模组控制设备”中的标志位"attr_flags" */ 
typedef_t struct {
  uint8_t flagRgbLed_OnOff:1;
  uint8_t flagRed_Led:1;
  uint8_t flagGreen_Led:1;
  uint8_t flagBlue_Led:1;
} attrFlags_t;

/** 对应协议“4.10 WiFi模组控制设备”中的数据值"attr_vals" */
typedef_t struct {
  uint8_t wBitBuf[COUNT_W_BIT];
  uint8_t valueRed_Led;
  uint8_t valueGreen_Led;
  uint8_t valueBlue_Led;
} attrVals_t;
