#ifndef __BSP_SPI_W25QXX_H
#define __BSP_SPI_W25QXX_H
...
//FLASH片选引脚
#define FL_CS_CLK      RCC_APB2Periph_GPIOA
#define FL_CS_PIN      GPIO_Pin_2
#define FL_CS_PORT     GPIOA

#define FL_CS(n)   if(n)   GPIO_SetBits(FL_CS_PORT,FL_CS_PIN); \
                    else \
                        GPIO_ResetBits(FL_CS_PORT,FL_CS_PIN)
...
#define SPI_NSS_GPIO_PIN			GPIO_Pin_2                   
